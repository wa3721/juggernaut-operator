...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JuggernautOverwrite) DeepCopyInto(out *JuggernautOverwrite) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JuggernautOverwrite.
func (in *JuggernautOverwrite) DeepCopy() *JuggernautOverwrite {
	if in == nil {
		return nil
	}
	out := new(JuggernautOverwrite)
	in.DeepCopyInto(out)
	return out
}
